...
export const homepageText = `
  <p>The Level Below Pro League was founded in 2024 by those in Sam "Octane" Larew's stream that wanted to have fun with fantasy football. League Comissioner: Nick_Inc</p>
`;
